	...
	<div class="content">
		<div class="content-container">
			...
			<div class="content-header">
				<h2 class="content-header-title">Menu</h2>
				<ol class="breadcrumb">
			...
			<div class="row">
				...
				<div class="col-sm-4">
					<div class="portlet">
						<div class="portlet-header">
							<h3><i class="fa fa-table"></i>Add Menu</h3>
						</div> <!-- /.portlet-header -->

						<div class="portlet-content">

							<form method="post" action="<?php echo base_url(); ?>blank/save_menu">
				...
				<div class="col-md-8">
					...
					<div class="portlet">
						<div class="portlet-header">
							<h3><i class="fa fa-table"></i>Management Menu</h3>
						</div> <!-- /.portlet-header -->
									...
									<tbody>
										<?php if (!isset($data_menu)){  
											...
											<tr>
												...
												<td style="width: 50px"><a href="<?=base_url()?>blank/edit_menu/<?=$row['menu_id']?>" title="Edit"><i class="fa fa-pencil-square-o fa-fw"></i> </a>  
												<a href="<?=base_url()?>blank/del_menu/<?=$row['menu_id']?>" title="Delete">
